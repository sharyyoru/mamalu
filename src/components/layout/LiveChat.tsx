...
export function LiveChat() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-gradient-to-r from-[#ff7f5c] to-[#e67854] rounded-full shadow-2xl flex items-center justify-center text-white hover:from-[#e67854] hover:to-[#d4684a] transition-all hover:scale-110 animate-bounce"
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="bg-gradient-to-r from-[#ff7f5c] to-[#e67854] p-4 flex items-center justify-between">
      ...
      {!isMinimized && (
        <>
          {/* Messages */}
          <div className="flex-1 h-[340px] overflow-y-auto p-4 space-y-4 bg-gradient-to-b from-[#ff7f5c]/5 to-white">
            {showForm ? (
              <form onSubmit={handleSubmitInfo} className="space-y-3">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-stone-200 focus:border-[#ff7f5c] focus:ring-2 focus:ring-[#ff7f5c]/20 outline-none text-sm"
                  required
                />
                <input
                  type="email"
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-[#ff7f5c] to-[#e67854] hover:from-[#e67854] hover:to-[#d4684a] text-white"
                >
                  ...
                  >
                    <div
                      className={`max-w-[80%] p-3 rounded-2xl ${
                        msg.sender === "user"
                          ? "bg-gradient-to-r from-[#ff7f5c] to-[#e67854] text-white rounded-br-md"
                  ...
                  <div className="flex justify-start">
                    <div className="bg-white border border-stone-100 p-3 rounded-2xl rounded-bl-md shadow-sm">
                      <div className="flex gap-1">
                        <span className="w-2 h-2 bg-[#ff7f5c] rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
                        <span className="w-2 h-2 bg-[#ff7f5c] rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
                        <span className="w-2 h-2 bg-[#ff7f5c] rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
                      </div>
                    </div>
                  </div>
                )}
            ...
            <div className="p-4 border-t border-stone-100 bg-white">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 rounded-xl border border-stone-200 focus:border-[#ff7f5c] focus:ring-2 focus:ring-[#ff7f5c]/20 outline-none text-sm"
                />
                <Button
                  onClick={handleSendMessage}
                  disabled={isLoading || !inputValue.trim()}
                  className="bg-gradient-to-r from-[#ff7f5c] to-[#e67854] hover:from-[#e67854] hover:to-[#d4684a] text-white px-4"
                >

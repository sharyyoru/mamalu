  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    ...
    <tr>
      <td style="padding: 50px 30px 30px; text-align: center;">
        ...
        <p style="color: #6b5f59; margin: 0; font-size: 15px;">Your payment has been received successfully</p>
      </td>
    </tr>
    ...
    <tr>
      <td style="padding: 30px; text-align: center; background-color: #fff7f2; border-top: 1px solid #f1d8cf; border-bottom: 1px solid #f1d8cf;">
        <h3 style="color: #FF8C6B; margin: 0 0 10px 0; font-size: 14px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">
